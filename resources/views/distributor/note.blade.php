                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Distributor Note
                            ...
                            <a href="{{ route('distributors.note.exportCSV', request()->only('brand_selection')) }}" class="btn btn-sm btn-cta float-end" data-bs-toggle="tooltip" title="Export data in CSV">
