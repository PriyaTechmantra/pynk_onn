                        ...
                        <div class="row">
                         <div class="col-xl-3 col-lg-2 col-12"></div>
                            <div class="col-xl-6 col-lg-8 col-12">
                                <form method="POST" action="{{route('schemes.store')}}" enctype="multipart/form-data" class="data-form">
                                @csrf
                                    <h4 class="page__subtitle">Add New Scheme</h4>
                                    <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-danger">Add New Scheme</button>
                                    </div>
                                </form>
                            </div>
