            ...
            <div class="col-md-12">
                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Scheme
                            <a href="{{url('schemes/create')}}" class="btn btn-sm btn-cta float-end">Add New Scheme</a>
                        </h4>
                                        ...
                                        <div class="row g-2 align-items-center">
                                            ...
                                            <div class="col-4 d-flex align-items-center gap-2">
                                                ...
                                                <select name="type" class="form-control form-control-sm">
                                                    ...
                                                    <option value="Current" {{ app('request')->input('type') == 'Current' ? 'selected' : '' }}>Current</option>
                                                    <option value="Past" {{ app('request')->input('type') == 'Past' ? 'selected' : '' }}>Past</option>
                                                </select>
                                            </div>
                            ...
                            <table class="table" id="example5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('schemes.status',$item->id) }}" ><span class="badge badge-status bg-{{($item->status == 1) ? 'success' : 'danger'}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</span></a></td>

                                         <td>
                                            <a href="{{route('schemes.edit', $item->id) }}" class="btn btn-cta">
                                           ...
                                           <a href="{{ route('schemes.view', $item->id) }}" class="btn btn-cta">
                                            ...
                                            <a href="{{ route('schemes.delete',$item->id) }}" class="btn btn-cta delete-confirm">
