                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Area
                            ...
                            @can('area export')
                            <a href="{{ url('areas/csv/export',['term'=>$request->term]) }}" class="btn btn-sm btn-cta float-end" data-bs-toggle="tooltip" title="Export data in CSV">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                                CSV
                            </a>
                            @endcan
                            @can('area bulk upload')
                            <a href="#csvModal" data-bs-toggle="modal" class="btn btn-sm btn-cta float-end"> Bulk Upload</a>
                            @endcan
                            @can('create area')
                            <a href="{{ url('areas/create') }}" class="btn btn-sm btn-cta float-end">Add Area</a>
                            @endcan
                        </h4>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('update area')
                                        <a href="{{ url('areas/'.$item->id.'/edit') }}" class="btn btn-cta">
                                        ...
                                        @can('delete area')
                                        <a href="{{ url('areas/'.$item->id.'/delete') }}" onclick="return confirm('Are you sure ?')" class="btn btn-cta">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ url('areas/bulk/upload') }}" enctype="multipart/form-data">@csrf
                    <input type="file" name="file" class="form-control" accept=".csv">
                    <div class="cta-row">
                    <a href="{{ asset('backend/csv/sample-area.csv') }}" class="btn-cta">Download Sample CSV</a>
