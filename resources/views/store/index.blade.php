                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4 class="d-flex">
                            ...
                            @endcan
                            @can('create store')
                            <a href="{{ url('stores/create') }}" class="btn btn-sm btn-cta">Add Employee</a>
                            @endcan
                        </h4>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <select name="state" id="state" class="form-select form-select-sm select2">
                                                            ...
                                                            @foreach ($state as $state)
                                                                <option value="{{$state->id}}" {{ request()->input('state') == $state->name ? 'selected' : '' }}>{{$state->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        ...
                                        <td>
                                            {{ substr($distName, 0, -1) ? substr($distName,0, -1) : '' }}
                                            
                                         
                                          
                                        </td>
                                        <td>
                                          {{ ucwords($item->address) }}<br>{{ $item->area->name }}<br>{{ $item->city }}<br>{{ $item->state->name }}
                                        </td>
                                        <td>{{ $item->wallet }}</td>
                                        <td>{{ $item->secret_pin }}</td>
                                        <td>
