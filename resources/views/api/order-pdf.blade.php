                    ...
                    <div id="DivIdToPrint">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm" style="border-left:2px solid #000; border-bottom:2px solid #000;">
                                <thead>
                                    @if(count(orderProductsUpdatedMatrix($orderProducts)) > 0)
                                    <tr>
                                ...
                                <tbody>
                                    @php
                                        $totalCOunt = 0;
                                    @endphp
                                    @foreach(orderProductsUpdatedMatrix($orderProducts) as $productKey => $productValue)
                                    ...
                                    @endforeach
                                    @endif
                                    @if(count(orderProductsUpdatedMatrixChild($orderProducts)) > 0)
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @php
                                            $totalProductCount = 0;
                                        @endphp
                                        @foreach(orderProductsUpdatedMatrixChild($orderProducts) as $productKey => $productOrderValue)
                                        @php
										 $color=\App\Models\Color::where('id',$productValue['color_id'])->first();
