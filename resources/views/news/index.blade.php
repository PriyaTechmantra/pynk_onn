            ...
            <div class="col-md-12">
                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>News
                            <a href="{{url('news/create')}}" class="btn btn-sm btn-cta float-end">Add New News</a>
                        </h4>
                            ...
                            <table class="table" id="example5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('news.status',$item->id) }}" ><span class="badge badge-status bg-{{($item->status == 1) ? 'success' : 'danger'}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</span></a></td>
                                         ...
                                         <td>
                                           ...
                                           <a href="{{ route('news.view', $item->id) }}" class="btn btn-cta">
                                            ...
                                            <a href="{{ route('news.delete',$item->id) }}" class="btn btn-cta delete-confirm">
