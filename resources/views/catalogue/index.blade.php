                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Catalogue
                            ...
                            <a href="{{route('catalogues.exportCSV', request()->only('term', 'brand_selection')) }}" class="btn btn-sm btn-cta float-end" data-bs-toggle="tooltip" title="Export data in CSV">
                            ...
                            <table class="table" id="example5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('catalogue status change')
                                            <a href="{{ route('catalogues.status',$item->id) }}" ><span class="badge badge-status bg-{{($item->status == 1) ? 'success' : 'danger'}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</span></a>
                                            @else
                                         ...
                                         <td>
                                            @can('update catalogue')
                                            <a href="{{route('catalogues.edit', $item->id) }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('view catalogue')
                                           <a href="{{ route('catalogues.view', $item->id) }}" class="btn btn-cta">
                                            ...
                                            <a href="{{ route('catalogues.delete',$item->id) }}" class="btn btn-cta delete-confirm">
