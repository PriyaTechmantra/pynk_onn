                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Product
                            ...
                            <a href="{{ url('collections/csv/export',['term'=>$request->term,'brand'=>$request->brand]) }}" class="btn btn-sm btn-cta float-end" data-bs-toggle="tooltip" title="Export data in CSV">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                                CSV
                            </a>
                           
                            <a href="{{ url('collections/create') }}" class="btn btn-sm btn-cta float-end">Add Collection</a>
                        </h4>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @endif
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>{{ $item->amount }}</td>
                                    <td><a href="{{ route('collection.view', $item->id) }}">{{$item->ProductDetails->count()}} products</a></td>
                                    <td><a href="{{ route('reward.retailer.product.status',$item->id)  }}" ><span class="badge badge-status bg-{{($item->status == 1) ? 'success' : 'danger'}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</span></a></td>
                                    <td>
                                        <a href="{{route('reward.retailer.product.edit',$item->id) }}" class="btn btn-cta">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 492.493 492" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M304.14 82.473 33.165 353.469a10.799 10.799 0 0 0-2.816 4.949L.313 478.973a10.716 10.716 0 0 0 2.816 10.136 10.675 10.675 0 0 0 7.527 3.114 10.6 10.6 0 0 0 2.582-.32l120.555-30.04a10.655 10.655 0 0 0 4.95-2.812l271-270.977zM476.875 45.523 446.711 15.36c-20.16-20.16-55.297-20.14-75.434 0l-36.949 36.95 105.598 105.597 36.949-36.949c10.07-10.066 15.617-23.465 15.617-37.715s-5.547-27.648-15.617-37.719zm0 0" fill="#ffffff" opacity="1" data-original="#000000" class=""></path></g></svg>
                                         ...
                                         <a href="{{ route('reward.retailer.product.view',$item->id)}}" class="btn btn-cta">
                                        ...
                                        <a href="{{ route('reward.retailer.product.delete',$item->id)}}" class="btn btn-cta delete-confirm">
