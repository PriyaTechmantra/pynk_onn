                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Collection
                            ...
                            <a href="" class="btn btn-sm btn-cta float-end" data-bs-toggle="tooltip" title="Export data in CSV">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('collections.status',$item->id) }}" ><span class="badge badge-status bg-{{($item->status == 1) ? 'success' : 'danger'}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</span></a></td>
                                         ...
                                         <td>
                                            <a href="{{route('collections.edit', $item->id) }}" class="btn btn-cta">
                                           ...
                                           <a href="{{ route('collections.view', $item->id) }}" class="btn btn-cta">
                                            ...
                                            <a href="{{ route('collections.delete',$item->id) }}" class="btn btn-cta delete-confirm">
