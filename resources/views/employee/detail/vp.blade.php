            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="col-12">
                    <p class="text-dark small">
                        States: {{vpStates($data->employee->id)->count()}}
                        | Area: {{vpAreaCount($data->employee->id)->count()}}
                        | RSM: {{vpRSMCount($data->employee->id)->count()}}
                        | ASM: {{vpASMCount($data->employee->id)->count()}}
                        | ASE: {{vpASECount($data->employee->id)->count()}}
                    </p>
                </div>
                            ...
                            <form class="row align-items-end justify-content-end" action="">
                                ...
                                <div class="col-auto">
                                    ...
                                    <select class="form-select form-select-sm" name="user_type" id="type">
                                        ...
                                        <option value="1" {{ ($request->user_type == 1) ? 'selected' : '' }} disabled>VP</option>
                                        <option value="2" {{ ($request->user_type == 2) ? 'selected' : '' }}>RSM</option>
                                        <option value="3" {{ ($request->user_type == 3) ? 'selected' : '' }}>ASM</option>
                                ...
                                <div class="col-auto">
                                    ...
                                    <select class="form-control form-control-sm" id="area" name="area" disabled>
...
document.getElementById("downloadCsv").addEventListener("click", function () {
    ...
    downloadLink.download = "team_information_vp.csv";
