            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="col-12">
                    <p class="text-dark small">
                        States: {{rsmStates($data->employee->id)->count()}}
                        | Area: {{rsmAreaCount($data->employee->id)->count()}}
                        | VP: {{rsmVp($data->employee->id)->count()}}
                        | ASM: {{rsmASMCount($data->employee->id)->count()}}
                        | ASE: {{rsmASECount($data->employee->id)->count()}}
                    </p>
                </div>
                            ...
                            <form class="row align-items-end justify-content-end" action="">
                                ...
                                <div class="col-auto">
                                    ...
                                    <select class="form-select form-select-sm" name="user_type" id="type">
                                        ...
                                        <option value="2" {{ ($request->user_type == 2) ? 'selected' : '' }} disabled>RSM</option>
...
document.getElementById("downloadCsv").addEventListener("click", function () {
    ...
    downloadLink.download = "team_information_rsm.csv";
