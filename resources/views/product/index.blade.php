                                        ...
                                        <div class="col-12">
                                            <form action="">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <label for="state" class="text-muted small">Collection</label>
                                                        <select name="collection_id" id="collection_id" class="form-control form-control-sm select2">
                                                            <option value="" selected disabled>Select</option>
                                                            <option value="" selected>All</option>
                                                            @foreach ($collection as $state)
                                                                <option value="{{$state->id}}" {{ request()->input('collection_id') == $state->id ? 'selected' : '' }}>{{$state->name}}</option>
                                                            @endforeach
                                                        </select>
                                                  </div>
                                              
                                                    <div class="col">
                                                        <label for="state" class="text-muted small">Category</label>
                                                        <select name="cat_id" id="cat_id" class="form-control form-control-sm select2">
                                                            <option value="" selected disabled>Select</option>
                                                            <option value="" selected>All</option>
                                                            @foreach ($category as $state)
                                                                <option value="{{$state->id}}" {{ request()->input('cat_id') == $state->id ? 'selected' : '' }}>{{$state->name}}</option>
                                                            @endforeach
                                                        </select>
                                                  </div>
                                                    <div class="col">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('products/'.$item->id.'/status/change') }}">
                                        ...
                                        <td style="white-space: nowrap;">
                                            @can('update product')
                                            <a href="{{ url('products/'.$item->id.'/edit') }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('view product')
                                            <a href="{{ url('products/'.$item->id) }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('delete product')
                                            <a  href="{{ url('products/'.$item->id.'/delete') }}" class="btn btn-cta delete-confirm">
