                                ...
                                <tbody>
                                    @forelse ($data as $index => $item)                                  
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            <a href="{{ url('reward/user/'.$item->id.'/edit') }}" class="btn btn-cta">
                                            ...
                                            <a href="{{ url('reward/user/'.$item->id.'/view') }}" class="btn btn-cta">
                                            ...
                                            @endcan
                                            @can('delete new registered stores')
                                            <a  href="{{ url('reward/user/'.$item->id.'/delete') }}" class="btn btn-cta delete-confirm">
