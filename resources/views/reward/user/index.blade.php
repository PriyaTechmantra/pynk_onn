                                    ...
                                    //}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <a href="{{route('reward.retailer.user.edit', $item->id) }}" class="btn btn-cta">
                                                ...
                                                <a href="{{ route('reward.retailer.user.view', $item->id) }}" class="btn btn-cta">
                                                    ...
                                                    <a href="{{ route('reward.retailer.user.delete',$item->id) }}" class="btn btn-cta delete-confirm">
