                                ...
                                <tbody>
                                    @forelse ($data as $index => $item)                                  
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            <a href="{{ url('reward/user/'.$data->id.'/edit') }}" class="btn btn-cta">
                                            ...
                                            <a href="{{ url('reward/user/'.$data->id.'/view') }}" class="btn btn-cta">
                                            ...
                                            <a  href="{{ url('reward/user/'.$data->id.'/delete') }}" class="btn btn-cta delete-confirm">
