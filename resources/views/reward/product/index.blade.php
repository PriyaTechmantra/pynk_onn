                    ...
                    <div class="card-header">
                        ...
                        <div class="search__filter mb-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <form action="{{route('reward.retailer.product.index')}}">
                                        <div class="row">
                                            <div class="col-3">
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @endif
                                    ...
                                    <td>{{ $item->amount }}</td>
                                    <td>
                                        @can('reward product status change')
                                        <a href="{{ route('reward.retailer.product.status',$item->id)  }}" ><span class="badge badge-status bg-{{($item->status == 1) ? 'success' : 'danger'}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</span></a>
                                        @else
                                              <span class="badge badge-status bg-{{($item->status == 1) ? 'success' : 'danger'}}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</span>
                                        @endcan
                                    </td>
                                    <td>
                                        @can('update reward product')
