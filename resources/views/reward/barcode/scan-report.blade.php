                ...
                <div class="card data-card mt-3">
                    <div class="card-header">
                        <h4>Store wise monthly scan report
                            <a href="{{ route('reward.qrcode.redeem.retailer.scan.report.csv.export', ['month'=>$request->month,'keyword'=>$request->keyword]) }}" class="btn btn-sm btn-cta float-end" data-bs-toggle="tooltip" title="Export data in CSV">
